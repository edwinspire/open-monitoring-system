...
<script type="text/javascript" src="events_jobs.js"></script>
</head>
...
<div class="ContentMasterWithoutHeader">
                        ...
                        <div id="grid_view_monitor" data-dojo-type="uDC_gridx/uDC_gridx"  data-udc-gridx-config="{structure: 'lib/custom/uDC_gridx/uDC_gridx_structure.php', url_export:'',  url_data:'lib/custom/uDC_gridx/gridx/view_events_jobs_last.php', table: 'view_events_jobs_last', auto_select_on_change: true,  auto_update_row: true, refresh_on_changed_table: ['events'], IndirectSelect: true, referential_field: 'idevent', fields: {dateevent: false, account: false, account_name: false, code: false, priority: false, label: false, job_name: false, job_run_duration: false,  description: false, status_label: false, oams_assigned: false}}"></div> 
    </div>
</div>
