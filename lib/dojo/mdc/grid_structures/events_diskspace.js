define("oams/grid_structures/events_diskspace",['dojo/_base/declare', 'dojo/Evented', 'dojo/date/locale'],function(_1, _2, _3){
...
drive: {r: {field:'drive', width: 'auto' , name:'drive'},  w: {field:'drive', editable: 'true', name:'drive'}},
drive_free: {r: {field:'drive_free', width: 'auto' , name:'drive_free'},  w: {field:'drive_free', editable: 'true', name:'drive_free'}},
drive_size: {r: {field:'drive_size', width: 'auto' , name:'drive_size'},  w: {field:'drive_size', editable: 'true', name:'drive_size'}},
