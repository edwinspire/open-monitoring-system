define("oams/grid_structures/equipments",['dojo/_base/declare', 'dojo/Evented', 'dojo/date/locale'],function(_1, _2, _3){
...
code_ref: {r: {field:'code_ref', width: 'auto' , name:'Código Ref.'},  w: {field:'code_ref', editable: 'true', name:'Código Ref.'}},
...
serial_number: {r: {field:'serial_number', width: 'auto' , name:'Numero serie'},  w: {field:'serial_number', editable: 'true', name:'Numero serie'}},
