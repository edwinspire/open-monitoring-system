define("oams/grid_structures/events_device_uptime",['dojo/_base/declare', 'dojo/Evented', 'dojo/date/locale'],function(_1, _2, _3){
...
uptime: {r: {field:'uptime', width: 'auto' , name:'uptime'},  w: {field:'uptime', editable: 'true', name:'uptime'}},
