define([
"dojo/_base/declare", 'dojo/request', 'dojo/query', "dojo/Evented"
], function(declare, _2, _3, _4){
    return declare("jspire/request/dbTuple", _2, _3, _4, {
//////////////////////////// Inicio
   changed: false,
...
console.warn(node.id+' '+node+' '+node.name);
                ...
                if (name) {
                    ...
                    if (value) {
                        ...
                        if (wi.get('data-dbfieldtype') == "checkbox") {
                            wi.set("checked", t._value_pg_to_field(wi.get('data-dbfieldtype'), value));
                        } else {
