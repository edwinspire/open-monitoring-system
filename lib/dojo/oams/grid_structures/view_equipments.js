...
installation_date: {r: {field:'installation_date', width: 'auto' , dataType: 'datetime',  name:'Fecha Instalación'},  w: {field:'installation_date', editable: 'true', dataType: 'datetime', name:'Fecha Instalación'}},
...
uninstall_date: {r: {field:'uninstall_date', width: 'auto' , dataType: 'datetime',  name:'Fecha Desinstalación'},  w: {field:'uninstall_date', editable: 'true', dataType: 'datetime', name:'Fecha Desinstalación'}}}
