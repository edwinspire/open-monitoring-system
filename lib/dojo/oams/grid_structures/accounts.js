...
end_date: {r: {field:'end_date', width: 'auto' , dataType: 'datetime',  name:'Fecha de finalización'},  w: {field:'end_date', editable: 'true', dataType: 'datetime', name:'Fecha de finalización'}},
