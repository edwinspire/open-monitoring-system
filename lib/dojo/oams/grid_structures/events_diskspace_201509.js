define("oams/grid_structures/events_diskspace_201509",['dojo/_base/declare', 'dojo/Evented'],function(_1, _2){
...
drive: {r: {field:'drive', name:'drive'},  w: {field:'drive', name:'drive'}},
drive_free: {r: {field:'drive_free', name:'drive_free'},  w: {field:'drive_free', name:'drive_free'}},
drive_size: {r: {field:'drive_size', name:'drive_size'},  w: {field:'drive_size', name:'drive_size'}},
