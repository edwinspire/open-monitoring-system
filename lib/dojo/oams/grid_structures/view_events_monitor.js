...
first_name: {r: {field:'first_name', width: 'auto' , name:'Farmacia'},  w: {field:'first_name', editable: 'true', name:'Farmacia'}},
...
label: {r: {field:'label', width: 'auto' , name:'Etiqueta Evento'},  w: {field:'label', editable: 'true', name:'Etiqueta Evento'}},
