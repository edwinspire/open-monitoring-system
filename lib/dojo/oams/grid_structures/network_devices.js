define("oams/grid_structures/network_devices",['dojo/_base/declare', 'dojo/Evented'],function(_1, _2){
...
installation_date: {r: {field:'installation_date', width: 'auto' , dataType: 'datetime',  name:'installation_date'},  w: {field:'installation_date', editable: 'true', dataType: 'datetime', name:'installation_date'}},
...
uninstall_date: {r: {field:'uninstall_date', width: 'auto' , dataType: 'datetime',  name:'uninstall_date'},  w: {field:'uninstall_date', editable: 'true', dataType: 'datetime', name:'uninstall_date'}},
