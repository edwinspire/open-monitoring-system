define("oams/grid_structures/contacts",['dojo/_base/declare', 'dojo/Evented'],function(_1, _2){

  return _1([_2], {
	structure: {address: {r: {field:'address', name:'Direccion'},  w: {field:'address', name:'Direccion'}},
