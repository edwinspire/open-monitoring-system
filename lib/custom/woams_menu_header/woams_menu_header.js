...
define(['dojo/_base/declare',
    'dijit/_Widget',
    'dijit/_Templated',
    'dojo/text!woams_menu_header/woams_menu_header.php',
    'dojo/request',
...
*/
            ...
            t.idmmonitor2.on('Click', function () {
                window.open('index.php', '_self');
            });
            ...
            t.idmcontacts.on('Click', function () {
             ...
             t.idmacfarmacias.on('Click', function(){
             window.open("reporte_aperturas_remodelaciones.php",'_self');
             });
