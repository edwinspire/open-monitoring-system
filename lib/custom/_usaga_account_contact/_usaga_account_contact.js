...
jsFS.addXmlLoader(t.listcontactsnew, '/uxsql/usaga_fun_view_account_unregistered_contacts_xml.uxsql', 'row', {}, 'idcontact', 'name');
},
_idaccount: 0,
_idcontact: 0,
...
if(t._idaccount > 0 && t._idcontact > 0){
   ...
   R.get('/uxsql/usaga_fun_account_contacts_byid.uxsql', {
...
var t = this;
//alert('uh');
   R.post('/uxsql/usaga_fun_account_contacts_table_xml.uxsql', {
		data: _data,
            // Parse data from xml
            handleAs: "xml"
        }).then(
