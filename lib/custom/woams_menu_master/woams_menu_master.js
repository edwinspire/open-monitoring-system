    ...
    return declare([_Widget, _Templated], {
        ...
        postCreate: function () {
            ...
            t.idmeventmanager.on('Click', function () {
                window.open("event_admin.php", '_self');
            });
            /*
            ...
            t.idmeventreportgeneral.on('Click', function () {
                window.open("report_event_general.php", '_self');
            });
            ...
            t.idmcontacts.on('Click', function () {
             ...
             window.open("map.php?maptype=0&with_contacts_users=false&with_menu=true",'_self');
             });

             
             t.idmrepadmin.on('Click', function(){
             window.open("report_admin.php", '_self');
             });
             
             t.idmrepevents.on('Click', function(){
             window.open("report_events.php",'_self');
             });
             
             t.idmrequipments.on('Click', function(){
             window.open("report_equipments.php",'_self');
             });

             t.idmrequipmentsnetwork.on('Click', function(){
             window.open("report_equipments_network.php",'_self');
             });

             
             t.idmadm.on('Click', function(){
             window.open("admins.php",'_self');
             });
