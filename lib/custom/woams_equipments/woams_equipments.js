...
create_grid_view_equipments: function(){
            ...
            t.Grid.set("structure", [{field: "unique_id", name: "#", width: '35px'},
                gs1s.enabled.r, gs1s.account.r, gs1s.accounttype.r, gs1s.account_name.r, gs1s.equipment.r, gs1s.mark.r, gs1s.model.r, gs1s.description.r, gs1s.operability.r, gs1s.note.r, gs1s.oams_assigned.r
            ]);
