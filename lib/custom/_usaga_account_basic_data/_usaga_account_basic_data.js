...
jsFS.addXmlLoader(t.idcontact, "/uxsql/fun_view_contacts_to_list_xml.uxsql", "row", {}, "idcontact", "name", {name: 'Ninguno', id: '0'});
...
t.disableFields(true);
   R.get('/uxsql/usaga_fun_view_account_byid_xml.uxsql', {
...
var t = this;
   ...
   R.post('/uxsql/usaga_fun_account_table_xml.uxsql', {
		data: _data,
            // Parse data from xml
            handleAs: "xml"
        }).then(
