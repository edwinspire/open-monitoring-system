...
'gridx/modules/pagination/PaginationBar'
 ...
 return declare([ _Widget, _Templated], {
	...
	_rows: 25,
	_idcontact: 0,
	_url_load: '/uxsql/fun_view_groups_xml.uxsql',
...
cols.push(columntypes[6]);
  t._url_load = '/uxsql/fun_view_contacts_groups_xml.uxsql';
  break;
//case 2:
//  execute code block 2
//  break;
default:
  t._url_load = '/uxsql/fun_view_groups_xml.uxsql';
cols.push(columntypes[0]);
...
var t = this;
if(t._function == 0){
R.post('/uxsql/fun_groups_remove_selected_xml.uxsql', {
   handleAs: "xml",
...
R.post('/uxsql/fun_groups_edit_xml.uxsql', {
   handleAs: "xml",
...
R.post('/uxsql/fun_contact_change_groups_xml.uxsql', {
   handleAs: "xml",
