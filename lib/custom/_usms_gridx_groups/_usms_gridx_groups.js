...
'gridx/modules/pagination/PaginationBar'
 ...
 return declare([ _Widget, _Templated], {
	...
	_rows: 25,
	_idcontact: 0,
	_url_load: '/php_query/fun_view_groups_json.php',
...
cols.push(columntypes[6]);
  t._url_load = '/php_query/fun_view_contacts_groups_json.php';
  break;
//case 2:
//  execute code block 2
//  break;
default:
  t._url_load = '/php_query/fun_view_groups_json.php';
cols.push(columntypes[0]);
...
var t = this;
if(t._function == 0){
R.post('/php_query/fun_groups_remove_selected_xml.php', {
   handleAs: "xml",
...
R.post('/php_query/fun_groups_edit_json.php', {
   handleAs: "json",
...
console.log(response[0].outpgmsg);
//MH.notification.notify({message: xmld.getStringFromB64(0, 'outpgmsg')});
}
}, function(error){
//MH.notification.notify({message: error});
...
R.post('/php_query/fun_contact_change_groups_xml.php', {
   handleAs: "xml",
