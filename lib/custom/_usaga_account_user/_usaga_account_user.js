...
jsFS.addXmlLoader(t.usersListnew, '/uxsql/usaga_fun_view_account_unregistered_contacts_xml.uxsql', 'row', {}, 'idcontact', 'name');
},
_idaccount: 0,
_idcontact: 0,
...
if(t._idaccount > 0 && t._idcontact > 0){
   ...
   R.get('/uxsql/usaga_fun_view_account_user_byidaccountidcontact_xml.uxsql', {
...
var t = this;
   ...
   R.post('/uxsql/usaga_fun_account_users_table_xml.uxsql', {
		data: _data,
            // Parse data from xml
            handleAs: "xml"
        }).then(
