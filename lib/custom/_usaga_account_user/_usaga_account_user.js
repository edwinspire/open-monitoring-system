...
jsFS.addXmlLoader(t.usersListnew, '/php_query/usaga_fun_view_account_unregistered_contacts_xml.php', 'row', {}, 'idcontact', 'name');
},
_idaccount: 0,
_idcontact: 0,
...
if(t._idaccount > 0 && t._idcontact > 0){
   ...
   R.get('/php_query/usaga_fun_view_account_user_byidaccountidcontact_xml.php', {
...
var t = this;
   ...
   R.post('/php_query/usaga_fun_account_users_table_xml.php', {
		data: _data,
            // Parse data from xml
            handleAs: "xml"
        }).then(
