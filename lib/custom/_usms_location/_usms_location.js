...
jsFS.addXmlLoader(t.fsL1, '/uxsql/fun_view_location_level_xml.uxsql', 'row', {level: 1}, 'idl1', 'name', {name: 'Ninguno', id: '0'});

jsFS.addXmlLoader(t.fsL2, '/uxsql/fun_view_location_level_xml.uxsql', 'row', {}, 'idl2', 'name', {name: 'Ninguno', id: '0'});
t._addFSLFunctions(t.fsL2, 2);

jsFS.addXmlLoader(t.fsL3, '/uxsql/fun_view_location_level_xml.uxsql', 'row', {}, 'idl3', 'name', {name: 'Ninguno', id: '0'});
t._addFSLFunctions(t.fsL3, 3);

jsFS.addXmlLoader(t.fsL4, '/uxsql/fun_view_location_level_xml.uxsql', 'row', {}, 'idl4', 'name', {name: 'Ninguno', id: '0'});
t._addFSLFunctions(t.fsL4, 4);

jsFS.addXmlLoader(t.fsL5, '/uxsql/fun_view_location_level_xml.uxsql', 'row', {}, 'idl5', 'name', {name: 'Ninguno', id: '0'});
t._addFSLFunctions(t.fsL5, 5);

jsFS.addXmlLoader(t.fsL6, '/uxsql/fun_view_location_level_xml.uxsql', 'row', {}, 'idl6', 'name', {name: 'Ninguno', id: '0'});
...
t.disableFields(true);
            ...
            request.get("/uxsql/fun_view_locations_ids_from_idlocation_xml.uxsql", {
            // Parse data from xml
