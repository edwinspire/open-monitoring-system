...
jsFS.addXmlLoader(t.fsL1, '/php_query/fun_view_location_level_xml.php', 'row', {level: 1}, 'idl1', 'name', {name: 'Ninguno', id: '0'});

jsFS.addXmlLoader(t.fsL2, '/php_query/fun_view_location_level_xml.php', 'row', {}, 'idl2', 'name', {name: 'Ninguno', id: '0'});
t._addFSLFunctions(t.fsL2, 2);

jsFS.addXmlLoader(t.fsL3, '/php_query/fun_view_location_level_xml.php', 'row', {}, 'idl3', 'name', {name: 'Ninguno', id: '0'});
t._addFSLFunctions(t.fsL3, 3);

jsFS.addXmlLoader(t.fsL4, '/php_query/fun_view_location_level_xml.php', 'row', {}, 'idl4', 'name', {name: 'Ninguno', id: '0'});
t._addFSLFunctions(t.fsL4, 4);

jsFS.addXmlLoader(t.fsL5, '/php_query/fun_view_location_level_xml.php', 'row', {}, 'idl5', 'name', {name: 'Ninguno', id: '0'});
t._addFSLFunctions(t.fsL5, 5);

jsFS.addXmlLoader(t.fsL6, '/php_query/fun_view_location_level_xml.php', 'row', {}, 'idl6', 'name', {name: 'Ninguno', id: '0'});
...
t.disableFields(true);
            ...
            request.get("/php_query/fun_view_locations_ids_from_idlocation_xml.php", {
            // Parse data from xml
