...
*/
jsFS.addXmlLoader(t.Provider, "/php_query/provider_listidname_xml.php", "row", {}, "idprovider", "name");
t.Provider.Load();
...
if(t._id > 0){
            ...
            request.get("/php_query/fun_view_phones_byid_xml.php", {
            // Parse data from xml
...
if(t.Formulario.validate()){
            // Request the text file
            request.post("/php_query/fun_phones_table_xml.php", {
            // Parse data from xml
	data: t.values(),
            handleAs: "xml"
        }).then(
