...
*/
jsFS.addXmlLoader(t.Provider, "/uxsql/provider_listidname_xml.uxsql", "row", {}, "idprovider", "name");
t.Provider.Load();
...
if(t._id > 0){
            ...
            request.get("/uxsql/fun_view_phones_byid_xml.uxsql", {
            // Parse data from xml
...
if(t.Formulario.validate()){
            // Request the text file
            request.post("/uxsql/fun_phones_table_xml.uxsql", {
            // Parse data from xml
	data: t.values(),
            handleAs: "xml"
        }).then(
