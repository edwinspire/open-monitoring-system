// Dojo 1.7+ (AMD)
require(["dojo/_base/lang", "custom/postgres/oms",  "dojo/node!pg", "dojo/_base/array"], function(lang, OMS, pg, array){
	lang.extend(OMS, {
/////////////////////////////////////////
udc_farma_view_lista_precios: function(req, res){
	...
	var list_promo = ['584','293','363','242','379','270','292','235','364','362','365','484','475','488','579','548','249','532','246','232','439','437','458','443','333','231','461','240','491','253','272','357','580','566','563','317','366','311','116','005','091','243','057','277','068','281','214','300','897','521','481','275','006','013','258','007','138','406','173','134','159','945','465','457','445','534','432','546','451','427','257','469','082','339','388','065','141','418','302','150','208','010','289','522','220','244','503','506','502','504','163','510','358','058','131','160','184','212','273','254','008','514','251','264','946','518','527','440','557','560','054','542','419','497','523','285','444','066','268','267','327','489','894','515','133','274'];
	...
	switch(post.UdcAction){
		...
		switch(req.body.Selection){
			...
			break;
			case 'pnatural':
			q = "SELECT * FROM view_farma_lista_precios  WHERE iddivision = 2 AND account_name ILIKE  '%PUNTO%' ORDER BY account";
			t.response_query(req, res, q, []);
			break;			
			case 'promo_medi':
