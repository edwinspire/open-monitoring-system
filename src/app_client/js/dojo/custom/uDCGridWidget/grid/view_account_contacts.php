...
header("Content-Disposition:attachment;filename=contacts_".date('Ymd-His').".ods");
$result = $db->export_as_html(true, "Contactos", array(), array(), "account_name, contact_name", 0, $_POST["udc_referential_field"], json_decode($_POST["udc_selected_id"]));
break;
