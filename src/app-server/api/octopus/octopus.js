/**
     ...
     * @module 
     */
     define(['dojo/_base/declare', 'dojo/Evented', 'api/postgres/oms', "dojo/request", "dstore/Memory", "api/postgres/oms_query_builder"
     	], function (declare, Evented, omsPostgreSQL, request, Memory) {
          ...
          getTaskTable: function(){
            return this.query(`
             ...
             octopus_by_account.idoctopus_byaccount,
