...
_run_check_movinv_connect_matriz: function(cnxmatriz, movsap, name_event){
    var t = this;
        ...
        with(nolock) WHERE tme_naturaleza_externo = '${tme_naturaleza_externo}' 
        AND tme_codigo_externo = '${tme_codigo_externo}') 
        AND tbl_maestromovinvent.FechaRegistro = CONVERT(VARCHAR, '${FechaRegistro}') 
        AND  tbl_movinvent.cantidad = '${cantidad}' 
