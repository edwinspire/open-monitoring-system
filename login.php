...
<div style="width: 100%; height: 80%;">
  <div data-dojo-type="dijit/form/Form" action="index.php" method="post" name="Login_Form oams" style="margin: auto; min-width: 1em; min-height: 1em; width: 20%; padding-top: 4em;">
    ...
    <table border="0" style="margin: auto; border-collapse: collapse; table-layout: fixed; height: auto; width: auto;">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <input type="text" data-dojo-type="dijit/form/TextBox" intermediateChanges="false" trim="false" uppercase="false" lowercase="false" propercase="false" selectOnClick="false" name="oams_user"></input>
          </td>
        </tr>
        <tr>
          <td style="padding: 0.5em;">
