...
const packageJson = fs_1.existsSync(packageJsonPath) ? require(packageJsonPath) : undefined;
...
function getJsonpFunction(name) {
...
function webpackConfig(args) {
    ...
    const config = {
        ...
        entry: includeWhen(args.element, args => {
            ...
            return Object.assign({}, includeWhen(args.withTests, () => {
                return {
                    ...
                    return [
                        {
                            ...
                            options: Object.assign({ tsConfigFile: path.join(basePath, 'tslint.json') }, includeWhen(!args.watch && !args.withTests, () => {
                                return {
                                    emitErrors: true,
                                    failOnHint: true
                                };
