(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@theintern/leadfoot/Session", "@dojo/core/async/Task"], factory);
    }
    ...
    var ProxiedSession = (function (_super) {
        ...
        ProxiedSession.prototype._getCoverage = function () {
            ...
            if (this.capabilities.brokenExecuteForNonHttpUrl) {
                shouldGetPromise = Task_1.default.resolve(this.getCurrentUrl().then(function (url) { return /^https?:/i.test(url); }));
            }
            else {
                shouldGetPromise = Task_1.default.resolve(true);
            }
