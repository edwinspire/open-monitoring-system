(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "fs", "http-errors", "mime-types", "path", "../node/util"], factory);
    }
    ...
    function instrument(context) {
        ...
        return function (request, response, next) {
            ...
            var wholePath = util_1.normalizePath(path_1.resolve(path_1.join(basePath, request.url)));
