        ...
        function BenchmarkReporter(executor, options) {
            ...
            if (_this.mode === 'test') {
                try {
                    ...
                    _this.console.warn('Unable to load benchmark baseline data from ' +
                        _this.filename);
