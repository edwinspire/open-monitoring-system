(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "charm", "istanbul-lib-coverage", "util", "@dojo/core/lang", "@dojo/shim/global", "../RemoteSuite", "./Reporter", "./TextCoverage"], factory);
    }
    ...
    var Pretty = (function (_super) {
        ...
        function Pretty(executor, options) {
            ...
            _this.colorReplacement = lang_1.mixin({
                0: 'green',
                1: 'magenta',
                2: 'red',
                '✓': 'green',
        ...
        Pretty.prototype.runStart = function () {
            ...
            var resize = function () {
                _this.dimensions.width = global_1.default.process.stdout.columns || 80;
                _this.dimensions.height = global_1.default.process.stdout.rows || 24;
            };
            resize();
            global_1.default.process.stdout.on('resize', resize);
            var rerender = function () {
                _this._charm.erase('screen').position(0, 0);
                _this._render();
                _this._renderTimeout = global_1.default.setTimeout(rerender, 200);
            };
            rerender();
        };
        Pretty.prototype.runEnd = function () {
            ...
            global_1.default.clearTimeout(this._renderTimeout);
        ...
        Pretty.prototype._newCharm = function () {
            var c = charm();
            c.pipe(global_1.default.process.stdout);
            return c;
        };
        ...
        Pretty.prototype._drawSessionReport = function (report) {
            ...
            var leftOfBar = fit(this._abbreviateEnvironment(report.environment).slice(0, titleWidth - 2) + ': ', titleWidth);
            var rightOfBar = '' +
