(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@dojo/shim/global", "./Reporter"], factory);
    }
    ...
    var Dom = (function (_super) {
        ...
        Dom.prototype.suiteEnd = function (suite) {
            this.suiteNode = (this.suiteNode.parentNode.parentNode ||
                this.document.body);
            if (suite.error) {
        ...
        Dom.prototype._scroll = function () {
            global_1.default.scrollTo(0, this.document.documentElement.scrollHeight ||
