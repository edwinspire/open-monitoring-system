(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "fs", "path", "shell-quote", "glob", "@dojo/core/async/Task", "@dojo/core/lang", "./process", "../common/util"], factory);
    }
    ...
    function getConfig(fileOrArgv, argv) {
        ...
        if (process_1.default.env['INTERN_ARGS']) {
            lang_1.mixin(args, util_1.parseArgs(shell_quote_1.parse(process_1.default.env['INTERN_ARGS'] || '')));
        }
        if (userArgs.length > 0) {
            lang_1.mixin(args, util_1.parseArgs(userArgs));
        }
        if (file) {
            args.config = file;
        }
