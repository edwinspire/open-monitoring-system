(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/core/async/Task", "./common/util", "./Deferred", "./Test"], factory);
    }
    ...
    var Suite = (function () {
        ...
        Suite.prototype.run = function () {
            ...
            return task
                ...
                var current;
                runTask = new Task_1.default(function (resolve, reject) {
                    var firstError;
                    var testTask;
                    var next = function () {
                        var test = tests[i++];
                        ...
                        var runTest = function () {
                            ...
                            testTask = new Task_1.default(function (resolve) {
                                result.then(resolve);
                            }, function () {
                                result.cancel();
                            });
        ...
        Suite.prototype.toJSON = function () {
            ...
            if (this.error) {
                ...
                if (this.error.relatedTest &&
                    this.error.relatedTest !== this) {
