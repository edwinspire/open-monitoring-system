(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@dojo/core/async/Task", "@dojo/core/lang", "lodash", "platform", "benchmark", "./Test"], factory);
    }
    ...
    var BenchmarkTest = (function (_super) {
        ...
        function BenchmarkTest(descriptor) {
            ...
            var options = lang_1.mixin({}, _this.test.options || {}, {
                async: true,
        ...
        BenchmarkTest.async = function (testFunction, numCallsUntilResolution) {
            testFunction.options = lang_1.mixin({}, testFunction.options || {}, {
                defer: true,
