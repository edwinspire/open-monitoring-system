...
import { BenchmarkDeferredTestFunction, BenchmarkTestFunction } from '../BenchmarkTest';
...
export declare function getInterface(executor: Executor): {
    ...
    async: (testFunction: BenchmarkDeferredTestFunction, numCallsUntilResolution?: number | undefined) => BenchmarkTestFunction;
};
