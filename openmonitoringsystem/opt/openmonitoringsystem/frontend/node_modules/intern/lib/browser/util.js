(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/core/request/providers/xhr", "@dojo/shim/global", "../common/util"], factory);
    }
    ...
    function getDefaultBasePath() {
        var match = /^(.*\/)node_modules\/intern\/?/.exec(global_1.default.location.pathname);
        if (match) {
            return match[1];
        }
        else {
    ...
    function loadText(path) {
        return xhr_1.default(path).then(function (response) {
            if (!response.ok) {
