(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "chai", "@dojo/core/lang", "@dojo/core/async/Task", "@dojo/shim/global", "../Suite", "../common/ErrorFormatter", "../common/path", "../common/util", "../interfaces/object", "../interfaces/tdd", "../interfaces/bdd", "../interfaces/benchmark", "../common/console"], factory);
    }
    ...
    var BaseExecutor = (function () {
        ...
        BaseExecutor.prototype.emit = function (eventName, data) {
            ...
            var notifications = Task_1.default.resolve();
            ...
            if (listeners && listeners.length > 0) {
                ...
                var _loop_1 = function (listener) {
                    notifications = notifications
                        .then(function () { return Task_1.default.resolve(listener(data)); })
            ...
            if (starListeners && starListeners.length > 0) {
                ...
                var _loop_2 = function (listener) {
                    notifications = notifications
                        .then(function () { return Task_1.default.resolve(listener(starEvent_1)); })
                        .then(handleErrorEvent)
                        .catch(handleListenerError);
                };
        ...
        BaseExecutor.prototype.registerLoader = function (init) {
            var options = this._loaderOptions
                ? lang_1.duplicate(this._loaderOptions)
                : {};
        ...
        BaseExecutor.prototype.registerPlugin = function (type, name, init) {
            ...
            var result = options ? pluginInit(lang_1.duplicate(options)) : pluginInit();
            if (Task_1.isThenable(result)) {
                this._loadingPlugins.push({
                    name: pluginName,
                    init: new Task_1.default(function (resolve, reject) {
                        return result.then(function (value) { return resolve(value); }, reject);
                    }, function () {
                        util_1.isTask(result) && result.cancel();
                    })
                });
            }
            else {
                ...
                try {
                    ...
                    if (this.config.showConfig) {
                        ...
                        this._runTask = this._runTask
                            ...
                            var outerTask;
                            var testingTask;
                            currentTask_1 = new Task_1.default(function (resolve, reject) {
                                outerTask = _this.emit('beforeRun')
                                    .then(function () {
                                    return _this.emit('runStart')
                                        .then(function () {
                                        return (testingTask = _this._runTests());
                                    })
                                        .catch(function (error) {
                                        runError_1 = error;
                                        return _this.emit('error', error);
        ...
        BaseExecutor.prototype._drainEventQueue = function () {
            var _this = this;
            var task = Task_1.default.resolve();
        ...
        BaseExecutor.prototype._emitCoverage = function (source) {
            var coverage = global_1.default[this.config.coverageVariable];
            if (coverage) {
        ...
        BaseExecutor.prototype._loadScripts = function (scripts, loader) {
            ...
            return scripts
                ...
                .then(function () {
                return Task_1.default.all(_this._loadingPlugins.map(function (entry) { return entry.init; })).then(function (plugins) {
        ...
        BaseExecutor.prototype._loadSuites = function () {
            ...
            return Task_1.default.resolve(this._loader(suites)).then(function () {
        ...
        BaseExecutor.prototype._resolveConfig = function () {
            ...
            if (config.benchmark) {
                config.benchmarkConfig = lang_1.deepMixin({
