(function (factory) {
    ...
    var Node = (function (_super) {
        ...
        Node.prototype.instrumentCode = function (code, filename) {
            ...
            try {
                var newCode = this._instrumenter.instrumentSync(code, path_1.normalize(filename), sourceMap);
        ...
        Node.prototype._afterRun = function () {
            ...
            return _super.prototype._afterRun.call(this).finally(function () {
                ...
                if (_this.tunnel) {
                    promises.push(_this.tunnel
                        .stop()
                        .then(function () {
                        return _this.emit('tunnelStop', { tunnel: _this.tunnel });
                    }));
                }
