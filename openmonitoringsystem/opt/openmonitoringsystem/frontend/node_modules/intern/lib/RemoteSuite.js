(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "url", "path", "@dojo/core/UrlSearchParams", "@dojo/core/async/Task", "./Suite", "./common/util", "./Deferred"], factory);
    }
    ...
    var RemoteSuite = (function (_super) {
        ...
        RemoteSuite.prototype.run = function () {
            ...
            return new Task_1.default(function (resolve, reject) {
                ...
                var connectTimeout = config.functionalTimeouts.connectTimeout != null
                ...
                var query = new UrlSearchParams_1.default(queryParams);
                ...
                remote
                    ...
                    return remote
                        ...
                        .finally(function () { return handleError(error); });
                });
