(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "body-parser", "express", "ws", "@dojo/core/aspect", "@dojo/core/lang", "./common/util", "./middleware/instrument", "./middleware/unhandled", "./middleware/finalError", "./middleware/resolveSuites", "./middleware/post"], factory);
    }
    ...
    var Server = (function () {
        ...
        Server.prototype.start = function () {
            ...
            return new Promise(function (resolve) {
                ...
                _this._wsServer = new WebSocket.Server({ port: _this.socketPort });
                _this._wsServer.on('connection', function (client) {
                    _this.executor.log('WebSocket connection opened:', client);
                    _this._handleWebSocket(client);
                });
                _this._wsServer.on('error', function (error) {
                ...
                var server = (_this._httpServer = app.listen(_this.port, function () {
                    resolve();
                }));
                var sockets = [];
                aspect_1.after(server, 'close', function () {
                    var socket;
        ...
        Server.prototype.stop = function () {
            ...
            if (this._app && this._httpServer) {
                promises.push(new Promise(function (resolve) {
                    ...
                    _this._app = _this._httpServer = null;
                }));
            }
            if (this._wsServer) {
                promises.push(new Promise(function (resolve) {
