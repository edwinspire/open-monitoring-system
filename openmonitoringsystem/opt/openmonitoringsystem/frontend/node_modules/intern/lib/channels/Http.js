(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@dojo/core/request/providers/xhr", "@dojo/core/async/Task", "./Base"], factory);
    }
    ...
    var HttpChannel = (function (_super) {
        ...
        function HttpChannel(options) {
            ...
            _this._lastRequest = Task_1.default.resolve();
            return _this;
        }
        ...
        HttpChannel.prototype._sendMessages = function () {
            ...
            this._activeRequest = xhr_1.default(this.url, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(block.map(function (entry) { return entry.message; }))
            })
