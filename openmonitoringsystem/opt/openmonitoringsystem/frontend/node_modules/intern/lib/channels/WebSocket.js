(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@dojo/core/async/Task", "@dojo/shim/global", "./Base", "../browser/util"], factory);
    }
    ...
    var WebSocketChannel = (function (_super) {
        ...
        function WebSocketChannel(options) {
            ...
            _this._socket = new global_1.default.WebSocket(protocol + "://" + host + ":" + options.port);
            _this._ready = new Task_1.default(function (resolve, reject) {
        ...
        WebSocketChannel.prototype._handleError = function (error) {
            var _this = this;
            this._ready = Task_1.default.reject(error);
