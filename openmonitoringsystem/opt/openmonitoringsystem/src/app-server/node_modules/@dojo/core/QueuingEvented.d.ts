...
import Evented, { EventedCallbackOrArray } from './Evented';
/**
 ...
 */
declare class QueuingEvented<M extends {} = {}, T = EventType, O extends EventObject<T> = EventObject<T>> extends Evented<M, T, O> {
    private _queue;
    maxEvents: number;
