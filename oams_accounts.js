...
udc_account_basic.on('onselect', function(e){
//console.log(e);
account_label_name.innerHTML = account_lastname.get('value')+' '+account_firtsname.get('value');
account_idcontact_label.innerHTML = e.data.idcontact;
loadTab(account_tab_container.selectedChildWidget.id, e.data.idcontact);

dojo.byId('udc_account_new_contact_form_idaccount').value = e.data.idcontact;
dojo.byId('udc_account_new_equipment_form_idaccount').value = e.data.idcontact;
dojo.byId('udc_account_new_networkdevices_form_idaccount').value = e.data.idcontact;
