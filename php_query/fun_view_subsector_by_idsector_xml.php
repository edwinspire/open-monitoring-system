...
/*<xsql>
	<uxsql_query driver='postgres' db_conexion_name='db1' native_xml='true'>SELECT * FROM fun_view_subsector_by_idsector_xml($1::integer, $2::boolean);</uxsql_query>
		<uxsql_parameter http_get='idsector'></uxsql_parameter>		
